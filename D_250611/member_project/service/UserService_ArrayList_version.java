...
import D_250611.member_project.util.Dateutil;
import D_250611.member_project.model.Member;
...
public class UserService_ArrayList_version {
    ...
    public static void addUser(Scanner scanner) {
        if (userCount < MAX_USERS) { // 기본 유효성 체크
            ...
            // 현재 날짜와 시간 저장
            String registrationDate = D_250611.member_project.util.Dateutil.getCurrentDateTime();
    ...
    public static void viewUsers() {
        ...
        for (int i = 0; i < members.size(); i++) {
            ...
            members.get(i).showInfo(); // -> 밴드 사진첩에 그림 설명 있음.
        }
    } // 회원 조회 메서드
    ...
    public static void deleteUser(Scanner scanner) {
        ...
        // 삭제
        members.remove(index); // 해당 인덱스의 회원 정보 삭제
