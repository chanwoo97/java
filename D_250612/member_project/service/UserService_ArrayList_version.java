package D_250612.member_project.service;
...
import D_250612.member_project.util.Dateutil;
import D_250612.member_project.model.Member;
...
public class UserService_ArrayList_version {
    ...
    // 정찬우,1234,jcw@naver.com,2025-06-12 10시10분
    // 정찬우2,1234,jcw2@naver.com,2025-06-12 10시10분
    ...
    private static void saveToFile() {
        ...
        // 전
        // try (FileWriter fw = new FileWriter("member.txt")) { -> UTF-8 적용이 안되고 있었음.
        // 변경, 한글 안깨지게, UTF-8 적용하기.
        try (OutputStreamWriter fw = new OutputStreamWriter(new FileOutputStream("member.txt"), "UTF-8")) {
