...
public class Exs_ch3_Main {
    public static void main(String[] args) {
        ...
        // quiz_1
        int[] numbers3 = new int[5]; // 크기가 5인 정수형 배열 생성
        for (int i = 0; i < numbers3.length; i++) {
            System.out.println((i + 1) + "번째 정수를 입력하세요: ");
            numbers3[i] = scanner.nextInt(); // 사용자로부터 정수 입력 받아 배열에 저장

            System.out.println("역순으로 출력:");
            for (int j = numbers3.length - 1; j >= 0; j--) {
        ...
        // System.out.println("===================================================================================");
        // System.out.println("1. 회원 추가 , 2. 회원 조회, 3. 회원 수정, 4. 회원 삭제, 5.더미 데이터 추가 5개
        // 0. 종료");
        // System.out.println("===================================================================================");
