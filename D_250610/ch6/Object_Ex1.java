...
public class Object_Ex1 {
    ...
    // Object에서 지원해주는 toString에 대해서,
    // 1) 기본 기능으로 사용하기.
    // 2) 재정의해서 사용하기.
    // 해당 객체를 출력 할 때, 우리가 정의한 내용을 toString()에 담을 수 있음.
    // Member member = new Member();
    // System.out.println(member), 출력하게되면
    // @Override
    // public String toString() { 여기의 내용을 반환을 함 }
    @Override
    public String toString() {
        String result = "이 클래스의 멤버 변수 name의 값 : " + name;
        return result;
    }
}
